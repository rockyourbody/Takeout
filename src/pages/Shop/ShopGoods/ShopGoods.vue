      ...
      <div class="foods-wrapper">
        <ul ref="foodsUl">
          <li class="food-list-hook" v-for="(good, index) in goods" :key="index">
            ...
            <ul>
              <li class="food-item bottom-border-1px" v-for="(food, index) in
good.foods" @click="showFood(food)">
                <div class="icon">
    ...
    <Food :food="food" v-if="isFoodShow" @isHidden="isHidden"></Food>
  </div>
</template>
<script>
